package com.harsh.assignment.adapter
...
import com.harsh.assignment.databinding.ItemMainRecyclerViewBinding

class MainRecyclerViewAdapter(private val listener: HomeFragment) : RecyclerView.Adapter<MainRecyclerViewAdapter.MainRecyclerViewHolder>() {
